...
<div class="logo">
<h1><a id="logo" href="<?= $home_url ?>" title="SpeedySMS.com.ng"><img class="scale-with-grid" src="<?php echo Yii::$app->request->baseUrl; ?>/web/images/logo.jpg" alt="speedysms logo"/></a></h1> </div>
...
<nav id="menu" class="menu-main-menu-container"><ul id="menu-main-menu" class="menu"><li id="menu-item-1647" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children"><a href="<?= $advantage_url ?>"><span>Why SpeedySMS</span></a>
<ul class="sub-menu ">
<li id="menu-item-844" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?= $advantage_url ?>"><span>Advantages</span></a></li>
<li id="menu-item-752" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?= $advantage_url . '#mission' ?>"><span>Mission</span></a></li>
<li id="menu-item-266" class="menu-item menu-item-type-post_type menu-item-object-page"><a href="<?= $advantage_url . '#vision' ?>"><span>Vision</span></a></li>
</ul>
</li>
